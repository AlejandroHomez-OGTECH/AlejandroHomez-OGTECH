...
class PagesItems extends StatefulWidget {
  @override
  State<PagesItems> createState() => _PagesItemsState();
}

class _PagesItemsState extends State<PagesItems> {
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ItemMisIdiomas(
                          index: index,
                          bandera: newProfileService.misIdiomas[index]);
                    }),
          ),
        ],
      ),
